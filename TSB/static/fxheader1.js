...
//        sd.style.overflowY='scroll';
        ...
        sd2.innerHTML='<div id="Scroller:fx" style="position:relative;padding:0px;margin-left:0px;"><div id="Scroller:content"><font size="3" color="red">Please wait while loading the table..</font></div></div>';
